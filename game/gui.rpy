...
define gui.name_text_font = "gui/Neucha-Regular.ttf"
...
define gui.dialogue_width = 1288
...
define gui.nvl_button_xpos = 250
...
init python:
    ...
    def small():
        ...
        gui.slot_button_height = 260
        gui.slot_button_text_size = 28
        gui.slot_spacing = 16
        config.thumbnail_width = 300
        config.thumbnail_height = 169
        gui.page_button_text_size = 42
        gui.page_spacing = 4
        ...
        gui.nvl_name_xpos = 220

        gui.nvl_text_width = 710
        gui.nvl_text_xpos = 250
        gui.nvl_text_ypos = 10

        gui.nvl_thought_width = 920
        gui.nvl_thought_xpos = 40

        gui.nvl_button_width = 920
        gui.nvl_button_xpos = 250
